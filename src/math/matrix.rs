...
impl Mat3 {
    ...
    pub fn inverse(&self) -> Self {
        ...
        let det = t1*self.data[8] - t2*self.data[7] - t3*self.data[8]+
                t4*self.data[7] + t5*self.data[5] - t6*self.data[4];
...
impl Mat4 {
    ...
    pub fn from_orientation_and_pos(orientation: Quat, pos: Vec3) -> Self {
        let Quat { r, i, j, k } = orientation;
    ...
    pub fn mul_mat4(&self, rhs: Self) -> Self {
        ...
        result.data[0] = rhs.data[0] * self.data[0] + rhs.data[4] * self.data[1] + rhs.data[8] * self.data[2];
        result.data[4] = rhs.data[0] * self.data[4] + rhs.data[4] * self.data[5] + rhs.data[8] * self.data[6];
        result.data[8] = rhs.data[0] * self.data[8] + rhs.data[4] * self.data[9] + rhs.data[8] * self.data[10];
        result.data[1] = rhs.data[1] * self.data[0] + rhs.data[5] * self.data[1] + rhs.data[9] * self.data[2];
        result.data[5] = rhs.data[1] * self.data[4] + rhs.data[5] * self.data[5] + rhs.data[9] * self.data[6];
        result.data[9] = rhs.data[1] * self.data[8] + rhs.data[5] * self.data[9] + rhs.data[9] * self.data[10];
        result.data[2] = rhs.data[2] * self.data[0] + rhs.data[6] * self.data[1] + rhs.data[10] * self.data[2];
        result.data[6] = rhs.data[2] * self.data[4] + rhs.data[6] * self.data[5] + rhs.data[10] * self.data[6];
        result.data[10] = rhs.data[2] * self.data[8] + rhs.data[6] * self.data[9] + rhs.data[10] * self.data[10];
        result.data[3] =
            rhs.data[3] * self.data[0] + rhs.data[7] * self.data[1] + rhs.data[11] * self.data[2] + self.data[3];
        result.data[7] =
            rhs.data[3] * self.data[4] + rhs.data[7] * self.data[5] + rhs.data[11] * self.data[6] + self.data[7];
        result.data[11] =
            rhs.data[3] * self.data[8] + rhs.data[7] * self.data[9] + rhs.data[11] * self.data[10] + self.data[11];
    ...
    pub fn inverse(&self) -> Self {
        ...
        data[3] = (self.data[9]*self.data[6]*self.data[3]
                ...
                -self.data[1]*self.data[6]*self.data[11])*det;
        data[7] = (-self.data[8]*self.data[6]*self.data[3]
                ...
                +self.data[0]*self.data[6]*self.data[11])*det;
        data[11] =(self.data[8]*self.data[5]*self.data[3]
                ...
                -self.data[0]*self.data[5]*self.data[11])*det;
